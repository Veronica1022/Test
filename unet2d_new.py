...
class UNet2D(nn.Module):
    ...
    def __init__(self, n_class=1, act='lrelu'):
        ...
        self.convmid = LUConv(512, 1024,3,act)
        self.convmid1 = LUConv(1024, 512,3,act)

        # self.convmid = nn.Sequential(LUConv(512, 1024, 3, act),
        #                              LUConv(1024, 512, 3, act))

        self.block5 = UpTransition(512, 512,act)
        self.block6 = UpTransition(512,256,act)
        self.block7 = UpTransition(256,128,act)
        self.block8 = UpTransition(128,64,act)

        self.block9 = OutputTransition(64, n_class)
    ...
    def forward(self, x):
        ...
        # self.outmid1= self.convmid(self.b4)

        self.outmid = self.convmid(self.b4)
        self.outmid1 = self.convmid1(self.outmid)

        self.b5 = self.block5(self.outmid1,self.skip_b4)
